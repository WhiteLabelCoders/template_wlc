...
class Footer {
	...
	public static function footer_main_menu() {
		...
		if ( $menu1 ) :
			...
			?>
		<div class="col-md-3 pl-0 pr-0 menu1-footer footer-accordion">
	...
	public static function footer_secondary_menu() {
		...
		if ( $menu2 ) :
			...
			<div class="col-md-3 pl-0 pr-0 menu2_footer footer_accordion">
				<h2 class="footer-subheading subheading"><?php echo $menu2->name; ?></h2>
				<div class=" footer-menu-footer">
					<ul>
	...
	public static function footer_third_menu() {
		...
		if ( $menu3 ) :
			...
			?>
			<div class="col-md-3 pl-0 pr-0 menu3_footer footer-accordion">
				<h2 class="footer_-subheading subheading"><?php echo $menu3->name; ?></h2>
				<div class=" footer-menu-footer">
					<ul>
	...
	public static function wrapper_footer_copy() {
		?>
		<div class="row footer-bottom--footer justify-end">
			<div class="col-md-9 footer-copyrights footer-bottom--footer--content">
				<div class="footer-copyrights--content">
					...
					<?php endif ?>
					<div class="footer-copyrights--design">
